...
class PolicyCondition(str, Enum):
    ...
    MODEL_IS = "model_is"
    FAITHFULNESS_SCORE_BELOW = "faithfulness_score_below"
...
class PolicyRule(BaseModel):
    ...
    #   faithfulness_score_below → score must be below this value (post-response only)
...
class GovernanceContext:
    ...
    # Only known after the LLM response streams back and RAGAS scoring runs —
    # None for the pre-response enforcement pass, set for the post-response check.
